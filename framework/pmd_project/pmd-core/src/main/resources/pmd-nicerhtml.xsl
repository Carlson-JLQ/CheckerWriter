...
<xsl:template match="pmd:pmd">
	<!--** Process root node framework : html header, style, call templates -->
	<html>
		<head>
	...
	<!--** Process root node framework, for mode 'rulelist' : violated rules -->
	<h3>Rules</h3>
	...
	<!--** Process root node framework, for mode 'filelist' : number of violations for each file -->
	<h3>Files</h3>
	<table class="log" border="0" cellpadding="5" cellspacing="2"
		width="100%">
		<tr>
	...
	<xsl:template match="pmd:pmd" mode="summary">
		<!--** Process root node 'framework',  for mode 'summary' : number of files, number of violations by severity -->
		<h3>Summary</h3>
		<table class="log" border="0" cellpadding="5" cellspacing="2"
			width="100%">
			<tr>
